    ...
    <nav class="flex items-center justify-between px-4 md:px-16 h-[70px] bg-blue-950">
        ...
        <ul class="hidden md:flex items-center gap-[11vw] text-[#E9E1DB] font-gothic" id="nav-links">
            ...
            <div class="flex items-center">
                <a href="{{ route('home') }}"><img class="w-12" src="{{ asset('images/logo.png') }}"
                        alt="logo"></a>
            </div>
        ...
        <ul class="fixed inset-0 left-0 w-full bg-blue-950 text-[#E9E1DB] font-title flex-col items-center gap-6 py-12 font-gothic hidden z-10"
            id="mobile-nav">
            <!-- Logo -->
            <div class="flex items-center">
